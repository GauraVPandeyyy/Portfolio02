          ...
          >
            {skillCategories.map((category) => (
              <motion.button
                ...
                className={`flex items-center space-x-3 px-4 md:px-8 md:py-4 rounded-2xl font-semibold transition-all duration-300 interactive ${activeSkillCategory === category.id
