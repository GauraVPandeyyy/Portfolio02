          ...
          >
            {skillCategories.map((category) => (
              <motion.button
                ...
                className={`flex items-center md:space-x-3 p-3 md:px-8 md:py-4 rounded-2xl font-semibold transition-all duration-300 interactive ${activeSkillCategory === category.id
