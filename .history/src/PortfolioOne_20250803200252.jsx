            ...
            <div className="hidden md:flex space-x-8">
              {navItems.map(({ id, label }) => (
                <motion.button
                  ...
                  className={`px-3 py-2 text-sm font-medium transition-colors duration-200 relative ${currentSection === id
                      ? "text-orange-400"
          ...
          >
            {skillCategories.map((category) => (
              <motion.button
                ...
                className={`flex items-center space-x-3 px-8 py-4 rounded-2xl font-semibold transition-all duration-300 ${activeSkillCategory === category.id
        ...
        <section id="testimonials" className="py-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={index}
                className={`bg-neutral-900/50 border rounded-2xl p-8 transition-all duration-300 cursor-pointer ${index === activeTestimonial
            ...
            >
              {[
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`text-neutral-400 ${social.color === 'orange' ? 'hover:text-orange-400' :
                      social.color === 'blue' ? 'hover:text-blue-400' :
                        social.color === 'sky' ? 'hover:text-sky-400' :
