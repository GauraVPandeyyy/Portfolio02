...
export default function EnhancedPortfolio() {
  ...
  const userData = {
    ...
    // Enhanced Bio
    bio: "Frontend developer with 1+ years of experience building enterprise-scale applications that serve millions of users. Specialized in React, JavaScript, and Tailwind. Led engineering teams at 2 successful startups from MVP to acquisition. Passionate about performance optimization, developer experience, and mentoring Interns.",
  ...
  const skills = {
    frontend: [
      { name: "React", level: 68, icon: "⚛️", years: 0.6, projects: 3 },
      // { name: "TypeScript", level: 92, icon: "📘", years: 5, projects: 25 },
      { name: "JavaScript", level: 96, icon: "🟨", years: 8, projects: 4 },
      { name: "Tailwind CSS", level: 90, icon: "🎨", years: 1, projects: 11 },
      { name: "Bootstrap", level: 88, icon: "💚", years: 1, projects: 3 },
    ],
    // backend: [
    ...
    tools: [
      { name: "Git", level: 80, icon: "📝", years: 1.5, projects: 10 },
      { name: "VS Code", level: 92, icon: "🐳", years: 2.5, projects: 20 },
      { name: "XAMPP", level: 60, icon: "☁️", years: 0.6, projects: 30 },
