...
// First, add useScroll and useTransform from framer-motion
import { motion, AnimatePresence, useScroll, useTransform } from "framer-motion";

// ...existing code...

// Inside the About section, modify the right div like this:
function AboutCodeDisplay() {
  ...
  return (
    <motion.div
      className="relative lg:sticky lg:top-32 lg:h-[calc(100vh-8rem)]"
      style={{
        y: yOffset,
        opacity
      }}
    ...
    >
      <div className="bg-neutral-900/70 border border-neutral-800 rounded-3xl p-8 shadow-2xl">
        ...
        <div className="font-mono text-sm space-y-3">
          {/* <motion.div
            className="text-purple-400" initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
...
// Then in your about section, replace the existing right div with:
<section id="about" className="py-20">
  <div className="text-center mb-16">
    {/* ... existing title code ... */}
  </div>
