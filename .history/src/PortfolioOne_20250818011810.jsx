          ...
          >
            {skillCategories.map((category) => (
              <motion.button
                ...
                className={`flex items-center space-x-2 md:space-x-3 p-3 md:px-8 md:py-4 rounded-2xl font-semibold transition-all duration-300 interactive ${activeSkillCategory === category.id
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-0 rounded-3xl pointer-events-none"></div>
                ...
                <div className="p-8 relative">
                  ...
                  <motion.div
                    className="grid grid-cols-3 gap-4 mb-6 p-2 md:p-4 bg-black/30 rounded-xl border border-neutral-800 group-hover:border-orange-500/30 transition-all duration-500"
                    whileHover={{
                      y: -3,
