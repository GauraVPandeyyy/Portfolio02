...
//           backgroundColor: isHovering ? "#f56d0f" : "#07ebeb",
//           borderRadius : 50,
//           // boxShadow :
//         }}
...
//       {/* Cursor ring */}
//       <motion.div
//         className="fixed w-8 h-8 border-4 border-orange-400/60 rounded-full pointer-events-none z-50 mix-blend-difference"
//         style={{
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
      ...
      {particles.map((particle) => (
        <motion.div
          key={particle.id}
          className="absolute rounded-full bg-gradient-to-r from-orange-400 to-red-500 shadow-2xl"
          style={{
