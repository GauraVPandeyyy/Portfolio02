              ...
              <div className="flex space-x-4 pt-6">
                {[
                  ...
                  <motion.a
                    ...
                    className={`w-14 h-14 bg-neutral-900 hover:bg-neutral-800 border border-neutral-700 hover:border-${social.color}-500 rounded-2xl flex items-center justify-center text-neutral-400 hover:text-${social.color}-400 transition-all duration-300`}
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                  >
                    {social.icon}
