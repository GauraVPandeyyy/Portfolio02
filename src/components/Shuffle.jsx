...
// Inside Shuffle.jsx (at the bottom)
const baseTw = 'inline-block whitespace-nowrap will-change-transform uppercase leading-none'; 
// Removed text-[4rem] so it inherits from the parent Hero h1
// 
